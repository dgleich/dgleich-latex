...
%                                 Coord  
%<--------------------------------------------------------------------------–>
\tikzset{arcoord style/.style={dashed,
                             \tkz@euc@linecolor,
                             >=latex',
                             ->}}
...
\if@tkz@coord@noxdraw\else\draw[arcoord style] (#2)--(#2 |- tkz@xline); \fi 
\if@tkz@coord@noydraw\else \draw[arcoord style] (#2)--(#2 -| tkz@yline);\fi   
